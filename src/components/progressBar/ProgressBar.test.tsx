  ...
  describe("ProgressBar", () => {
    ...
    it("applies default trackVariant styling", () => {
      render(<ProgressBar value={50} />);
      const track = getTrack();
      expect(track).toHaveClass("bg-[color-mix(in_srgb,var(--atom-theme-border-primary)_8%,transparent)]");
    });
    ...
    it("applies trackVariant subtle", () => {
      ...
      const track = getTrack();
      expect(track).toHaveClass("bg-[color-mix(in_srgb,var(--atom-theme-border-primary)_6%,var(--atom-bg))]");
    });
