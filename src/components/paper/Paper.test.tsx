...
beforeEach(() => {
  document.documentElement.style.setProperty('--atom-theme-surface-primary', '#ffffff');
  document.documentElement.style.setProperty('--atom-theme-border-primary', '#e5e7eb');
...
describe('Paper Component', () => {
  ...
  describe('Variant Props', () => {
    it('should render outlined variant by default', () => {
      ...
      expect(paper).toHaveClass('border-[var(--atom-theme-border-primary)]');
    });
  ...
  describe('Base Styling', () => {
    ...
    it('should always apply background color variable', () => {
      ...
      const paper = screen.getByTestId('paper');
      expect(paper).toHaveClass('bg-[var(--atom-theme-surface-primary)]');
    });
